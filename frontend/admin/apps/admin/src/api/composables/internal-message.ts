...
export function useListInternalMessages(
  ...
  return useQuery({
    ...
    queryFn: () =>
      apiClient.internalMessageService.ListMessage(query.toRawParams()),
    ...options,
  });
}
...
export async function fetchListInternalMessages(params: PaginationQuery) {
  return queryClient.fetchQuery({
    ...
    queryFn: () =>
      apiClient.internalMessageService.ListMessage(params.toRawParams()),
    staleTime: 0,
    retry: 0,
  });
}
...
export function useListUserInbox(
  ...
  return useQuery({
    ...
    queryFn: () =>
      apiClient.internalMessageRecipientService.ListUserInbox(
        query.toRawParams(),
      ),
    ...options,
  });
...
export function useDeleteNotificationFromInbox(
  ...
  return useMutation({
    mutationFn: (data) =>
      apiClient.internalMessageRecipientService.DeleteNotificationFromInbox(
        data,
      ),
    ...options,
  });
...
export function useMarkNotificationAsRead(
  ...
  return useMutation({
    mutationFn: (data) =>
      apiClient.internalMessageRecipientService.MarkNotificationAsRead(data),
    ...options,
  });
}
