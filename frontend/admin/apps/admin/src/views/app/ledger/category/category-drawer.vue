...
const [BaseForm, baseFormApi] = useVbenForm({
  ...
  schema: [
    ...
    },
    {
      component: 'Select',
      fieldName: 'type',
      label: $t('page.ledger.category.type'),
      rules: 'selectRequired',
      componentProps: {
        options: [
          {
            value: 'CATEGORY_TYPE_EXPENSE',
            label: $t('enum.ledger.categoryType.CATEGORY_TYPE_EXPENSE'),
          },
          {
            value: 'CATEGORY_TYPE_INCOME',
            label: $t('enum.ledger.categoryType.CATEGORY_TYPE_INCOME'),
          },
        ],
    ...
    },
    {
      component: 'InputNumber',
      fieldName: 'parentId',
      label: $t('page.ledger.category.parentId'),
      componentProps: {
        placeholder: $t('ui.placeholder.input'),
        allowClear: true,
      },
    },
    {
      component: 'Textarea',
      fieldName: 'notes',
      label: $t('page.ledger.category.notes'),
      componentProps: {
        placeholder: $t('ui.placeholder.input'),
        allowClear: true,
      },
