...
// The BalanceFlowFunc type is an adapter to allow the use of ordinary
// function as BalanceFlow mutator.
type BalanceFlowFunc func(context.Context, *ent.BalanceFlowMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BalanceFlowFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BalanceFlowMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BalanceFlowMutation", m)
}
...
// The BookTemplateFunc type is an adapter to allow the use of ordinary
// function as BookTemplate mutator.
type BookTemplateFunc func(context.Context, *ent.BookTemplateMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BookTemplateFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BookTemplateMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BookTemplateMutation", m)
}
...
// The CategoryRelationFunc type is an adapter to allow the use of ordinary
// function as CategoryRelation mutator.
type CategoryRelationFunc func(context.Context, *ent.CategoryRelationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CategoryRelationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CategoryRelationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CategoryRelationMutation", m)
}
...
// The FlowFileFunc type is an adapter to allow the use of ordinary
// function as FlowFile mutator.
type FlowFileFunc func(context.Context, *ent.FlowFileMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f FlowFileFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.FlowFileMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.FlowFileMutation", m)
}
...
// The NoteDayFunc type is an adapter to allow the use of ordinary
// function as NoteDay mutator.
type NoteDayFunc func(context.Context, *ent.NoteDayMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f NoteDayFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.NoteDayMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.NoteDayMutation", m)
}
...
// The PayeeFunc type is an adapter to allow the use of ordinary
// function as Payee mutator.
type PayeeFunc func(context.Context, *ent.PayeeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PayeeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PayeeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PayeeMutation", m)
}
...
// The TagRelationFunc type is an adapter to allow the use of ordinary
// function as TagRelation mutator.
type TagRelationFunc func(context.Context, *ent.TagRelationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TagRelationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TagRelationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TagRelationMutation", m)
}
