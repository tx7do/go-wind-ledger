...
func (_q *AccountQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *AccountQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *AccountQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *AccountQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *AccountQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *AccountQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AccountQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(account.Table, account.Columns, sqlgraph.NewFieldSpec(account.FieldID, field.TypeUint32))
	_spec.From = _q.sql
