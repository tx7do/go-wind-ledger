...
func (UserRole) Mixin() []ent.Mixin { return []ent.Mixin{mixin.AutoIncrementId{},mixin.TimeAt{},mixin.TenantID[uint32]{},mixin.OperatorID{}} }
func (UserRole) Fields() []ent.Field {
	return []ent.Field{
		field.Enum("status").NamedValues("Pending","PENDING","Active","ACTIVE","Disabled","DISABLED","Expired","EXPIRED").Default("ACTIVE").Optional().Nillable(),
