...
func (UserOrgUnit) Mixin() []ent.Mixin { return []ent.Mixin{mixin.AutoIncrementId{},mixin.TimeAt{},mixin.TenantID[uint32]{},mixin.OperatorID{}} }
func (UserOrgUnit) Fields() []ent.Field {
	return []ent.Field{
		field.Enum("status").NamedValues("Active","ACTIVE","Pending","PENDING","Inactive","INACTIVE","Suspended","SUSPENDED","Expired","EXPIRED").Default("ACTIVE").Optional().Nillable(),
