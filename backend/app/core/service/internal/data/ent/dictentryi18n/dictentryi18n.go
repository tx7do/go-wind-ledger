...
const (
	...
	// FieldDictEntryID holds the string denoting the dict_entry_id field in the database.
	FieldDictEntryID = "dict_entry_id"
...
// ByDictEntryID orders the results by the dict_entry_id field.
func ByDictEntryID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldDictEntryID, opts...).ToFunc()
}
