...
// The BalanceFlowQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type BalanceFlowQueryRuleFunc func(context.Context, *ent.BalanceFlowQuery) error

// EvalQuery return f(ctx, q).
func (f BalanceFlowQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.BalanceFlowQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.BalanceFlowQuery", q)
}

// The BalanceFlowMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type BalanceFlowMutationRuleFunc func(context.Context, *ent.BalanceFlowMutation) error

// EvalMutation calls f(ctx, m).
func (f BalanceFlowMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.BalanceFlowMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.BalanceFlowMutation", m)
}
...
// The CategoryRelationQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type CategoryRelationQueryRuleFunc func(context.Context, *ent.CategoryRelationQuery) error

// EvalQuery return f(ctx, q).
func (f CategoryRelationQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.CategoryRelationQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.CategoryRelationQuery", q)
}

// The CategoryRelationMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type CategoryRelationMutationRuleFunc func(context.Context, *ent.CategoryRelationMutation) error

// EvalMutation calls f(ctx, m).
func (f CategoryRelationMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.CategoryRelationMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.CategoryRelationMutation", m)
}
...
// The FlowFileQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type FlowFileQueryRuleFunc func(context.Context, *ent.FlowFileQuery) error

// EvalQuery return f(ctx, q).
func (f FlowFileQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.FlowFileQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.FlowFileQuery", q)
}

// The FlowFileMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type FlowFileMutationRuleFunc func(context.Context, *ent.FlowFileMutation) error

// EvalMutation calls f(ctx, m).
func (f FlowFileMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.FlowFileMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.FlowFileMutation", m)
}
...
// The NoteDayQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type NoteDayQueryRuleFunc func(context.Context, *ent.NoteDayQuery) error

// EvalQuery return f(ctx, q).
func (f NoteDayQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.NoteDayQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.NoteDayQuery", q)
}

// The NoteDayMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type NoteDayMutationRuleFunc func(context.Context, *ent.NoteDayMutation) error

// EvalMutation calls f(ctx, m).
func (f NoteDayMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.NoteDayMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.NoteDayMutation", m)
}
...
// The PayeeQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type PayeeQueryRuleFunc func(context.Context, *ent.PayeeQuery) error

// EvalQuery return f(ctx, q).
func (f PayeeQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.PayeeQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.PayeeQuery", q)
}

// The PayeeMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type PayeeMutationRuleFunc func(context.Context, *ent.PayeeMutation) error

// EvalMutation calls f(ctx, m).
func (f PayeeMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.PayeeMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.PayeeMutation", m)
}
...
// The TagRelationQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type TagRelationQueryRuleFunc func(context.Context, *ent.TagRelationQuery) error

// EvalQuery return f(ctx, q).
func (f TagRelationQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.TagRelationQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.TagRelationQuery", q)
}

// The TagRelationMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type TagRelationMutationRuleFunc func(context.Context, *ent.TagRelationMutation) error

// EvalMutation calls f(ctx, m).
func (f TagRelationMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.TagRelationMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.TagRelationMutation", m)
}
