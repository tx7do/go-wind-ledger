...
INSERT INTO balance_flows (
    ...
    (1, 1, 'FLOW_TYPE_EXPENSE',  25.50,  25.50,  1, null, 1, 2, 1717372800000, '早餐',     '便利店早餐',   true, true, 1717372800000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  880.00, 880.00, 2, null, 1, 2, 1717459200000, '聚餐',     '朋友聚餐',     true, true, 1717459200000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  45.00,  45.00,  1, null, 2, 2, 1717545600000, '打车',     '通勤打车',     true, true, 1717545600000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  300.00, 300.00, 2, null, 3, 2, 1717632000000, '加油',     '高速加油',     true, true, 1717632000000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  15.00,  15.00,  1, null, 1, 2, 1717718400000, '午餐',     '工作日午餐',   true, true, 1717718400000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  220.00, 220.00, 2, null, 1, 2, 1717804800000, '晚餐',     '商务晚餐',     true, true, 1717804800000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  60.00,  60.00,  1, null, 2, 2, 1717891200000, '打车',     '机场打车',     true, true, 1717891200000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  480.00, 480.00, 2, null, 3, 2, 1717977600000, '加油',     '郊区加油',     true, true, 1717977600000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_INCOME',   5000.00,5000.00,1, null, null, 2, 1718064000000, '工资',     '月度工资',     true, true, 1718064000000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_INCOME',   120.00, 120.00, 1, null, null, 2, 1718150400000, '理财收益', '基金分红',     true, true, 1718150400000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  30.00,  30.00,  1, null, 1, 2, 1718236800000, '早餐',     '便利店早餐',   true, true, 1718236800000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  90.00,  90.00,  1, null, 2, 2, 1718323200000, '打车',     '夜间打车',     true, true, 1718323200000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_TRANSFER', 1000.00,1000.00,1, 2, null, 2, 1718409600000, '转账',     '信用卡还款',   true, true, 1718409600000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  75.00,  75.00,  2, null, 1, 2, 1718496000000, '午餐',     '工作日午餐',   true, true, 1718496000000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  15.00,  15.00,  1, null, 1, 2, 1718582400000, '早餐',     '便利店早餐',   true, true, 1718582400000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_INCOME',   80.00,  80.00,  1, null, null, 2, 1718668800000, '理财收益', '国债利息',     true, true, 1718668800000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_ADJUST',   50.00,  50.00,  1, null, null, 2, 1718755200000, '余额调整', '账目校正',     true, true, 1718755200000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  300.00, 300.00, 2, null, 3, 2, 1718841600000, '加油',     '高速加油',     true, true, 1718841600000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  40.00,  40.00,  1, null, 2, 2, 1718928000000, '打车',     '通勤打车',     true, true, 1718928000000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  25.00,  25.00,  1, null, 1, 2, 1719014400000, '早餐',     '便利店早餐',   true, true, 1719014400000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  120.00, 120.00, 2, null, 1, 2, 1719100800000, '聚餐',     '同事聚餐',     true, true, 1719100800000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_INCOME',   90.00,  90.00,  1, null, null, 2, 1719187200000, '理财收益', 'P2P回款',      true, true, 1719187200000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  35.00,  35.00,  1, null, 2, 2, 1719273600000, '打车',     '通勤打车',     true, true, 1719273600000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_TRANSFER', 500.00, 500.00, 1, 2, null, 2, 1719360000000, '转账',     '信用卡还款',   true, true, 1719360000000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  15.00,  15.00,  1, null, 1, 2, 1719446400000, '早餐',     '便利店早餐',   true, true, 1719446400000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  60.00,  60.00,  1, null, 2, 2, 1719532800000, '打车',     '通勤打车',     true, true, 1719532800000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  200.00, 200.00, 2, null, 3, 2, 1719619200000, '加油',     '郊区加油',     true, true, 1719619200000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_INCOME',   75.00,  75.00,  1, null, null, 2, 1719705600000, '理财收益', '基金分红',     true, true, 1719705600000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  45.00,  45.00,  1, null, 2, 2, 1719792000000, '打车',     '机场打车',     true, true, 1719792000000, NOW(), NOW()),
    (1, 1, 'FLOW_TYPE_EXPENSE',  18.00,  18.00,  1, null, 1, 2, 1719878400000, '早餐',     '便利店早餐',   true, true, 1719878400000, NOW(), NOW());
