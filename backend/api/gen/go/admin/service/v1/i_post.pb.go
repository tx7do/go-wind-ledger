...
var file_admin_service_v1_i_post_proto_depIdxs = []int32{
	...
	1, // 1: admin.service.v1.PostService.Get:input_type -> content.service.v1.GetPostRequest
...
func file_admin_service_v1_i_post_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_admin_service_v1_i_post_proto_rawDesc), len(file_admin_service_v1_i_post_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
