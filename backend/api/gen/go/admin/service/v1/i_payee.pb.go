...
var File_admin_service_v1_i_payee_proto protoreflect.FileDescriptor
...
var file_admin_service_v1_i_payee_proto_depIdxs = []int32{
	0, // 0: admin.service.v1.PayeeService.List:input_type -> pagination.PagingRequest
	1, // 1: admin.service.v1.PayeeService.ListAll:input_type -> ledger.service.v1.ListAllPayeeRequest
	2, // 2: admin.service.v1.PayeeService.Get:input_type -> ledger.service.v1.GetPayeeRequest
	3, // 3: admin.service.v1.PayeeService.Create:input_type -> ledger.service.v1.CreatePayeeRequest
...
func init() { file_admin_service_v1_i_payee_proto_init() }
func file_admin_service_v1_i_payee_proto_init() {
	if File_admin_service_v1_i_payee_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_admin_service_v1_i_payee_proto_rawDesc), len(file_admin_service_v1_i_payee_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_admin_service_v1_i_payee_proto_goTypes,
		DependencyIndexes: file_admin_service_v1_i_payee_proto_depIdxs,
	}.Build()
	File_admin_service_v1_i_payee_proto = out.File
	file_admin_service_v1_i_payee_proto_goTypes = nil
	file_admin_service_v1_i_payee_proto_depIdxs = nil
}
