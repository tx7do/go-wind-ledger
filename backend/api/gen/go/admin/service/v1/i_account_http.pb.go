...
const OperationAccountServiceAdjustBalance = "/admin.service.v1.AccountService/AdjustBalance"
const OperationAccountServiceCreate = "/admin.service.v1.AccountService/Create"
const OperationAccountServiceDelete = "/admin.service.v1.AccountService/Delete"
...
func (c *AccountServiceHTTPClientImpl) AdjustBalance(ctx context.Context, in *v11.AdjustBalanceRequest, opts ...http.CallOption) (*v11.Account, error) {
	var out v11.Account
	pattern := "/admin/v1/accounts/{id}/adjust"
