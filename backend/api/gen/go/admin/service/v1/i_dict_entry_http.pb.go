...
func RegisterDictEntryServiceHTTPServer(s *http.Server, srv DictEntryServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/dict/entries", _DictEntryService_List8_HTTP_Handler(srv))
	r.POST("/admin/v1/dict/entries", _DictEntryService_Create5_HTTP_Handler(srv))
	r.PUT("/admin/v1/dict/entries/{id}", _DictEntryService_Update5_HTTP_Handler(srv))
	r.DELETE("/admin/v1/dict/entries", _DictEntryService_Delete5_HTTP_Handler(srv))
	r.GET("/admin/v1/dict/entries/by-type-code", _DictEntryService_ListByTypeCode0_HTTP_Handler(srv))
}

func _DictEntryService_List8_HTTP_Handler(srv DictEntryServiceHTTPServer) func(ctx http.Context) error {
...
func _DictEntryService_Create5_HTTP_Handler(srv DictEntryServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _DictEntryService_Update5_HTTP_Handler(srv DictEntryServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _DictEntryService_Delete5_HTTP_Handler(srv DictEntryServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
