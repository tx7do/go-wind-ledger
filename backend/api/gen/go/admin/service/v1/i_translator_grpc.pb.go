...
import (
	context "context"
	v1 "go-wind-cms/api/gen/go/translator/service/v1"
...
const (
	TranslatorService_Translate_FullMethodName = "/admin.service.v1.TranslatorService/Translate"
)
...
type TranslatorServiceClient interface {
	// 翻译文本
	Translate(ctx context.Context, in *v1.TranslateRequest, opts ...grpc.CallOption) (*v1.TranslateResponse, error)
}
...
func (c *translatorServiceClient) Translate(ctx context.Context, in *v1.TranslateRequest, opts ...grpc.CallOption) (*v1.TranslateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.TranslateResponse)
...
func (UnimplementedTranslatorServiceServer) Translate(context.Context, *v1.TranslateRequest) (*v1.TranslateResponse, error) {
...
func _TranslatorService_Translate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TranslatorServiceServer).Translate(ctx, req.(*v1.TranslateRequest))
	}
...
var TranslatorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "admin.service.v1.TranslatorService",
	...
	Metadata: "admin/service/v1/i_translator.proto",
}
