...
func _PositionService_List31_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
...
func _PositionService_Create23_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _PositionService_Update23_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _PositionService_Delete24_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
