...
var File_admin_service_v1_i_dict_type_proto protoreflect.FileDescriptor

const file_admin_service_v1_i_dict_type_proto_rawDesc = "" +
	"\n" +
	"\"admin/service/v1/i_dict_type.proto\x12\x10admin.service.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1epagination/v1/pagination.proto\x1a\x1fdict/service/v1/dict_type.proto2\xcb\x04\n" +
	...
	"\x06Delete\x12&.dict.service.v1.DeleteDictTypeRequest\x1a\x16.google.protobuf.Empty\"\x1c\x82\xd3\xe4\x93\x02\x16*\x14/admin/v1/dict/typesB\xbc\x01\n" +
	"\x14com.admin.service.v1B\x0eIDictTypeProtoP\x01Z2go-wind-ledger/api/gen/go/admin/service/v1;adminpb\xa2\x02\x03ASX\xaa\x02\x10Admin.Service.V1\xca\x02\x10Admin\\Service\\V1\xe2\x02\x1cAdmin\\Service\\V1\\GPBMetadata\xea\x02\x12Admin::Service::V1b\x06proto3"
...
var file_admin_service_v1_i_dict_type_proto_goTypes = []any{
	...
	(*v11.DeleteDictTypeRequest)(nil), // 4: dict.service.v1.DeleteDictTypeRequest
	(*v11.ListDictTypeResponse)(nil),  // 5: dict.service.v1.ListDictTypeResponse
	(*v11.DictType)(nil),              // 6: dict.service.v1.DictType
...
func init() { file_admin_service_v1_i_dict_type_proto_init() }
func file_admin_service_v1_i_dict_type_proto_init() {
	if File_admin_service_v1_i_dict_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_admin_service_v1_i_dict_type_proto_rawDesc), len(file_admin_service_v1_i_dict_type_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_admin_service_v1_i_dict_type_proto_goTypes,
		DependencyIndexes: file_admin_service_v1_i_dict_type_proto_depIdxs,
	}.Build()
	File_admin_service_v1_i_dict_type_proto = out.File
	file_admin_service_v1_i_dict_type_proto_goTypes = nil
	file_admin_service_v1_i_dict_type_proto_depIdxs = nil
}
