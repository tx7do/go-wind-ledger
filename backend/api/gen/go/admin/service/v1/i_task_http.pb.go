...
import (
	...
	v11 "go-wind-ledger/api/gen/go/task/service/v1"
...
func RegisterTaskServiceHTTPServer(s *http.Server, srv TaskServiceHTTPServer) {
	...
	r.POST("/admin/v1/tasks", _TaskService_Create21_HTTP_Handler(srv))
	r.PUT("/admin/v1/tasks/{id}", _TaskService_Update21_HTTP_Handler(srv))
	r.DELETE("/admin/v1/tasks/{id}", _TaskService_Delete22_HTTP_Handler(srv))
...
func _TaskService_Create21_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TaskService_Update21_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TaskService_Delete22_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
