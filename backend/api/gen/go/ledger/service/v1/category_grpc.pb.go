...
const (
	CategoryService_List_FullMethodName    = "/ledger.service.v1.CategoryService/List"
	CategoryService_ListAll_FullMethodName = "/ledger.service.v1.CategoryService/ListAll"
	CategoryService_Get_FullMethodName     = "/ledger.service.v1.CategoryService/Get"
	CategoryService_Create_FullMethodName  = "/ledger.service.v1.CategoryService/Create"
	CategoryService_Update_FullMethodName  = "/ledger.service.v1.CategoryService/Update"
	CategoryService_Delete_FullMethodName  = "/ledger.service.v1.CategoryService/Delete"
	CategoryService_Toggle_FullMethodName  = "/ledger.service.v1.CategoryService/Toggle"
)
...
type CategoryServiceClient interface {
	...
	// 获取所有分类
	ListAll(ctx context.Context, in *ListAllCategoryRequest, opts ...grpc.CallOption) (*ListCategoryResponse, error)
	// 获取分类数据
	...
	// 切换启用/禁用
	Toggle(ctx context.Context, in *ToggleCategoryRequest, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) ListAll(ctx context.Context, in *ListAllCategoryRequest, opts ...grpc.CallOption) (*ListCategoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListCategoryResponse)
...
func (c *categoryServiceClient) Toggle(ctx context.Context, in *ToggleCategoryRequest, opts ...grpc.CallOption) (*Category, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	// 获取所有分类
	ListAll(context.Context, *ListAllCategoryRequest) (*ListCategoryResponse, error)
	// 获取分类数据
	...
	// 切换启用/禁用
	Toggle(context.Context, *ToggleCategoryRequest) (*Category, error)
...
func (UnimplementedCategoryServiceServer) ListAll(context.Context, *ListAllCategoryRequest) (*ListCategoryResponse, error) {
...
func (UnimplementedCategoryServiceServer) Toggle(context.Context, *ToggleCategoryRequest) (*Category, error) {
...
func _CategoryService_ListAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).ListAll(ctx, req.(*ListAllCategoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CategoryService_Toggle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).Toggle(ctx, req.(*ToggleCategoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ledger.service.v1.CategoryService",
	...
	Metadata: "ledger/service/v1/category.proto",
}
