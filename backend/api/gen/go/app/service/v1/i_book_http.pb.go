...
func _BookService_Get2_HTTP_Handler(srv BookServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _BookService_Create2_HTTP_Handler(srv BookServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _BookService_Update2_HTTP_Handler(srv BookServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _BookService_Delete2_HTTP_Handler(srv BookServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func (c *BookServiceHTTPClientImpl) Toggle(ctx context.Context, in *v11.ToggleBookRequest, opts ...http.CallOption) (*v11.Book, error) {
	var out v11.Book
	pattern := "/app/v1/books/{id}/toggle"
	path := binding.EncodeURL(pattern, in, false)
