...
func RegisterCurrencyServiceHTTPServer(s *http.Server, srv CurrencyServiceHTTPServer) {
	...
	r.GET("/app/v1/currencies", _CurrencyService_List4_HTTP_Handler(srv))
...
func _CurrencyService_List4_HTTP_Handler(srv CurrencyServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
